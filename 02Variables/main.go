...
func main() {
	fmt.Println("This File is all About the Variables")

	// to declare the variables use var keyword argument and then datatype and values
	var name string = "Shivam B"
